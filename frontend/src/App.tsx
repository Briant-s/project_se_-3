...
import { Elig_Overview, QuizPage } from "./eligibility";
          ...
          <Routes>
            ...
            <Route element={<PrivateRouter />}>
              <Route element={<AppLayout />}>
                ...
                />
                <Route
                  path="/business-proposal/edit/:proposalID"
                  element={<BusinessProposal />}
                />
                <Route
                ...
                />
                <Route
                  path="/business-proposal/result/:id"
                  element={<BusinessProposalResult />}
                />
                <Route
                  path="/ai-business-proposal/result/:id"
                  element={<AIBusinessProposalResult />}
                />
              </Route>
            </Route>
          </Routes>
